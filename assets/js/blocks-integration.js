...
const PawaPayContent = ({ data, eventRegistration, emitResponse }) => {
        ...
        const unsubscribe = onPaymentSetup(() => {
            ...
            if (Object.keys(newErrors).length > 0) {
                ...
                return {
                    ...
                    message: __('Veuillez corriger les erreurs dans le formulaire PawaPay.', 'wc-pawapay'),
    ...
    return React.createElement('div', { className: 'wc-pawapay-blocks-content' },
        ...
        }, __('Conversion en cours...', 'wc-pawapay')),
        ...
        }, __('Service de conversion temporairement indisponible', 'wc-pawapay'))
    );
};
...
const PawaPayPaymentMethod = {
    ...
    placeOrderButtonLabel: __('Payer avec PawaPay', 'wc-pawapay'),
};
